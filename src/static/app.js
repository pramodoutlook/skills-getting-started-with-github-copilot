document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear loading message and reset the activity select list
      ...
      Object.entries(activities).forEach(([name, details]) => {
              ...
              <div class="participants">
                ...
                <ul class="participants-list">
                  ${details.participants
                    .map(
                      (participant) =>
                        `<li><span class="participant-name">${participant}</span><button class="remove-participant" type="button" data-activity="${encodeURIComponent(
                          name
        ...
        // Connect delete buttons for participants
